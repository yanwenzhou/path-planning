function [psi_d, r_d, y_e] = ILOS(x,y,Delta,kappa,h,R_switch,wpt,U,K_f)
...
persistent k;      % active waypoint index (initialized by: clear ILOSpsi) 标记了路径点的序号
persistent xk yk;  % active waypoint (xk, yk) corresponding to integer k 标记了第K个路径点的序号
